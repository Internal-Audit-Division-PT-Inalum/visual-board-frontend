		...
		<div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-6 font-sans">
			<div className="flex items-center justify-between mb-5">
				<div className="flex items-center gap-3">
					...
					<div>
						<h3 className="font-extrabold text-slate-800 text-base tracking-tight">
							Trend Abnormality 5R
						</h3>
						<p className="text-slate-500 text-xs mt-0.5">
							Rekap per zona X=Temuan O=Selesai Δ=Belum Selesai
						</p>
					</div>
				</div>
				...
				<div className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-full px-3 py-1.5">
					...
					<span className="font-black text-slate-800 text-sm w-12 text-center">
						{year}
					</span>
					<button
						onClick={() => setYear((y) => y + 1)}
			...
			<div className="flex items-center gap-4 mt-4 pt-3 border-t border-slate-100 text-[10px] font-bold">
				<span className="flex items-center gap-1.5">
					...
					<span className="text-slate-500">X = Jumlah Temuan</span>
				</span>
				<span className="flex items-center gap-1.5">
					<span className="w-3 h-3 rounded-sm bg-emerald-100 border border-emerald-300"></span>
					<span className="text-slate-500">O = Sudah Ditindaklanjuti</span>
				</span>
				<span className="flex items-center gap-1.5">
					<span className="w-3 h-3 rounded-sm bg-amber-100 border border-amber-300"></span>
					<span className="text-slate-500">Δ = Belum Selesai</span>
				</span>
			</div>
		</div>
	);
