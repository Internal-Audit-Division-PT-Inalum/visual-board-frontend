import { Users, CheckCircle, HeartPulse, FileText } from 'lucide-react';
...
export function AttendanceStats({ total, present, sick, leave }: AttendanceStatsProps) {
    ...
    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-4 sm:gap-6 font-sans">
      ...
      <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-5 flex items-center gap-4 relative overflow-hidden group">
        ...
        <div className="relative z-10 flex-1">
          <p className="text-slate-500 font-bold text-xs uppercase tracking-wider mb-1">Kehadiran (Hadir)</p>
          <div className="flex items-baseline gap-2">
            <h4 className="text-3xl font-black text-slate-800">{present}</h4>
            <span className="text-sm font-bold text-emerald-500 bg-emerald-50 px-2 py-0.5 rounded-full">{percentage}%</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-5 flex items-center gap-4 relative overflow-hidden group">
        ...
        <div className="relative z-10">
          <p className="text-slate-500 font-bold text-xs uppercase tracking-wider mb-1">Cuti / Izin</p>
      ...
      <div className="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-5 flex items-center gap-4 relative overflow-hidden group">
        ...
        <div className="relative z-10">
          <p className="text-slate-500 font-bold text-xs uppercase tracking-wider mb-1">Sakit</p>
      ...
      <div className="bg-[#0A2F66] rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-5 flex items-center gap-4 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <p className="text-blue-200 font-bold text-xs uppercase tracking-wider mb-1">Total Karyawan</p>
